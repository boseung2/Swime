...
<%--                &lt;%&ndash;                <a id="back" class="btn btn-dark">취소</a>&ndash;%&gt;--%>

<%--                &lt;%&ndash;                <button data-oper="modify" class=""&ndash;%&gt;--%>


<%--                &lt;%&ndash;                <form id="modifyForm" role="form" action="/board/remove" method="post">&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    <button type="submit" data-oper='remove' class="btn btn-danger">삭제</button>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    <sec:csrfInput/>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                </form>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                    <button data-oper='remove' class="btn btn-default">삭제</button>&ndash;%&gt;--%>
<%--            </div>--%>
...
<%--            <label>좋아요</label>--%>
<%--            &lt;%&ndash;                <label><c:out value="${board.likeCnt}"/> </label>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                <label>${count}</label>&ndash;%&gt;--%>
...
<%--                    &lt;%&ndash;                    <img class="reply_profile2" src="../../../resources/image/img_avatar2.png" alt="error">&ndash;%&gt;--%>
...
<%--    &lt;%&ndash;let likeBundle = document.getElementById("likeBundle")&ndash;%&gt;--%>
<%--    &lt;%&ndash;let like1 = document.getElementById("likeCnt1");&ndash;%&gt;--%>
<%--    &lt;%&ndash;let like2 = document.getElementById("likeCnt2");&ndash;%&gt;--%>
<%--    &lt;%&ndash;//좋아요 클릭시 좋아요 함수 호출&ndash;%&gt;--%>
<%--    &lt;%&ndash;likeBundle.onclick = function(){&ndash;%&gt;--%>
<%--    &lt;%&ndash;    let sendData = {"userId" : "${board.userId}", "sn":"${board.sn}"};&ndash;%&gt;--%>
<%--    &lt;%&ndash;    console.log(sendData);&ndash;%&gt;--%>
<%--    &lt;%&ndash;    clickLike(sendData);&ndash;%&gt;--%>
<%--    &lt;%&ndash;}&ndash;%&gt;--%>
<%--    &lt;%&ndash;//기능 구현&ndash;%&gt;--%>
<%--    &lt;%&ndash;function clickLike(sendData){&ndash;%&gt;--%>
<%--    &lt;%&ndash;    $.ajax({&ndash;%&gt;--%>
<%--    &lt;%&ndash;        type: "post",&ndash;%&gt;--%>
<%--    &lt;%&ndash;        url: "/clickLike",&ndash;%&gt;--%>
<%--    &lt;%&ndash;        data : sendData,&ndash;%&gt;--%>
